...
class TestTradingControls:
    ...
    def test_trading_mode_toggle(self, dashboard_with_data):
        ...
        trading_mode_radio = page.locator('label:has-text("Trading Mode")').locator('..').locator('input[type="radio"]')
        ...
        for mode in modes:
            ...
            mode_button = page.locator(f'label:has-text("{mode}")').locator('..').locator('input[type="radio"]')
    ...
    def test_trading_mode_ui_changes(self, dashboard_with_data):
        ...
        # Test Manual mode
        manual_button = page.locator('label:has-text("Manual")').locator('..').locator('input[type="radio"]')
        ...
        # Test Off mode
        off_button = page.locator('label:has-text("Off")').locator('..').locator('input[type="radio"]')
    ...
    def test_emergency_stop_button_visibility(self, dashboard_with_data):
        ...
        assert 'primary' in button_classes.lower() or emergency_stop.get_attribute('type') == 'primary', \
    ...
    def test_emergency_stop_confirmation_flow(self, dashboard_with_data):
        ...
        warning_text = page.locator('text="This will immediately close all positions and halt trading!"')
    ...
    def test_auto_refresh_controls(self, dashboard_with_data):
        ...
        auto_refresh_checkbox = page.locator('text="Auto Refresh"').locator('..').locator('input[type="checkbox"]')
