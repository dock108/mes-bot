...
class TestConfigurationManagement:
    ...
    def test_configuration_section_navigation(self, dashboard_with_data):
        ...
        assert "Configuration" in current_section or "config" in current_section.lower() or "settings" in current_section.lower()
    ...
    def test_configuration_settings_display(self, dashboard_with_data):
        ...
        expected_settings = [
            "Max Trades", "Profit Target", "Stop Loss", "Initial Capital",
            "Risk Per Trade", "Implied Move Multiplier", "Volatility Threshold"
        ]
        ...
        for setting_name, invalid_value in invalid_settings.items():
            try:
                ...
                if error_messages.count() > 0:
                    ...
                    dashboard.take_screenshot(f"validation_error_{setting_name.lower().replace(' ', '_')}")
    ...
    def test_configuration_reset_functionality(self, dashboard_with_data):
        ...
        reset_buttons = page.locator('button:has-text("Reset"), button:has-text("Default"), button:has-text("Restore")')
    ...
    def test_configuration_help_documentation(self, dashboard_with_data):
        ...
        help_elements = page.locator('text=/Help|Info|?|Documentation/, [title*="help"], [aria-label*="help"]')
